...
@WebServlet("/ViewProductsByCategoriesServlet")
public class ViewProductsByCategoriesServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    try {
      ...
      request.getRequestDispatcher("viewProductsByCategories.jsp").forward(request, response);
